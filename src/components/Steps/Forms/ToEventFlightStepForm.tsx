...
import { ToEventFlightList } from "~/components/Flight";
    ...
    <div className="mb-6">
      <div className="mb-4 mt-6">
        ...
        <span className="mt-2 inline-block text-sm text-slate-500">
          Choose the country you are flying from
        </span>
      </div>
      <Form {...form}>
        <form
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Choose your location. We&apos;ll find the nearest airport for
                  you!
                </FormDescription>
                <FormMessage />
              </FormItem>
      ...
      {formHasBeenSubmittedOnce && (
        <section className="mt-12">
          <ToEventFlightList userData={serverDataMemoized} />
        </section>
      )}
    </div>
  );
...
export default ToEventFlightStepForm;
